...
const projects = [
  {
    title: "FUJITEC pvt ltd, Chennai",
    description:
      "June 2025 - Present",
    link: "https://www.fujitecindia.com",
    image: "/fujitec.png",
    blurhash:"L1SPX|xvtn~q00t7_2Io00oe-pM|"
  },
  {
    title: "TALENT PRO, Chennai",
    description:
      "July 2023 - June 2025",
    link: "https://www.talentproindia.com",
    image: "/talent.png",
    blurhash:"L2SF;N%M_4-;00WBRjj[00WB9Eaz"
  },
  {
    title: "PHEONIX LIFT, Chennai",
    description: "November 2021 - May 2023",
    link: "https://www.justdial.com/Chennai/Phoenix-Lift-MKB-Nagar-Near-BSNL-Office-Perungalathur/044PXX44-XX44-170908213035-L9G5_BZDET",
    image: "/pheonix.png",
     blurhash:"L1TI,a?bWA_3IVofM{%M00t7Rjxu"
  },
  {
    title: "SPEED ELEVATOR, Chennai",
    description:
      "September 2020 - November 2021",
    link: "https://share.google/aimode/HSXp3ox22UBAohsnW",
    image: "/speed.png",
  ...
  {
    title: "EasterEgg",
    description: "Free movie download platform in high quality.",
    link: "https://hicine.info",
    image: "/hicine.png",
    ...
    <div className="relative flex flex-col items-center justify-center w-full py-20 px-4 bg-black">
      ...
      <div className="relative z-10 mb-12 text-center">
        ...
        <p className="mt-4 text-neutral-400 text-sm md:text-base max-w-xl mx-auto">
          Exploring solutions, fixing challenges, and keeping lifts running safely — here’s what I’ve experienced so far.
        </p>
      </div>
      ...
      <div>
      <a 
      href="https://github.com/AjinAju20"
      target="_blank"
      rel="noopener noreferrer"

...
import { FaGithub, FaInstagram, FaLinkedin, FaDiscord, FaEnvelope, FaFacebook } from "react-icons/fa";
      ...
      <div className="relative flex min-h-[50rem] md:min-h-screen w-full items-center justify-center bg-black overflow-hidden px-4 py-16">
        ...
        <div className="relative z-20 text-center">
          ...
          <div className="flex justify-center gap-4 mt-6 text-2xl">
            ...
            <a
              href="https://www.instagram.com/_ajin_aju_3_/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/share/1APUwtZv6i/"
              target="_blank"
              rel="noopener noreferrer"
              className="icon-circle hover:text-blue-500 transition"
            >
              <FaFacebook />
            </a>
            <a
              href="https://www.linkedin.com/in/ajin-aju-a33b1677c/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="icon-circle hover:text-indigo-500 transition"
            >
              <FaDiscord />
            </a>
            <a
              href="mailto:ajinthomas2000@gmail.com"
              className="icon-circle hover:text-red-400 transition"
            >
              <FaEnvelope />
            </a>
          </div>
